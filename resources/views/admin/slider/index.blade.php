                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="q"
                                    placeholder="cari berdasarkan nama slider">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="text-align: center">SLIDER</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row" style="text-align: center">
                                        ...
                                        @php
                                            $pathInfo = pathinfo(url($slider->image));
                                            $extension = strtolower($pathInfo['extension']);
                                        @endphp

                                        @if($extension === 'mp4')
                                            <video width="360" controls style="object-fit: cover;">
                                                <source src="{{ url($slider->image) }}" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        @else
                                            <img src="{{ url($slider->image) }}" style="width:360px;object-fit: cover;">
                                        @endif
                                    </td>
                                    <td>{{ $slider->link }}</td>
                                    <td class="text-center">
